    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-md-6">
                        <a href="paket_tambah.php" class="btn btn-primary box-title" style="background-color: black; border-color: black;"><i class="fa fa-plus fa-fw"></i> Tambah</a>
                    </div>
                    ...
                    <table class="table table-bordered thead-dark" id="table">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th style="color: black; border: 1px solid black">Nama Paket</th>
                                <th style="color: black; border: 1px solid black">Jenis</th>
                                <th style="color: black; border: 1px solid black">Harga</th>
                                <th style="color: black; border: 1px solid black">Outlet</th>
                        ...
                        <tbody>
                            <?php foreach($data as $paket): ?>
                                <tr>
                                    ...
                                    <td style="color: black; border: 1px solid black"><?= htmlspecialchars($paket['nama_paket']); ?></td>
                                    <td style="color: black; border: 1px solid black"><?= htmlspecialchars($paket['jenis_paket']); ?></td>
                                    <td style="color: black; border: 1px solid black"><?= htmlspecialchars($paket['harga']); ?></td>
                                    <td style="color: black; border: 1px solid black"><?= htmlspecialchars($paket['nama_outlet']); ?></td>
