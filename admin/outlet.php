    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-md-6">
                        <a href="outlet_tambah.php" class="btn btn-primary box-title" style="background-color: black; border-color: black;"><i class="fa fa-plus fa-fw"></i> Tambah</a>
                    </div>
                    ...
                    <table class="table table-bordered thead-dark" id="table">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th style="color: black; border: 1px solid black">Owner</th>
                                <th style="color: black; border: 1px solid black">No Telepon</th>
                                <th style="color: black; border: 1px solid black">Alamat</th>
                                <th style="color: black; border: 1px solid black">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach($data as $outlet): ?>
                                <tr>
                                    ...
                                    <td style="color: black; border: 1px solid black"><?= htmlspecialchars($outlet['nama_outlet']); ?></td>
                                    ...
                                    <td style="color: black; border: 1px solid black"><?= htmlspecialchars($outlet['telp_outlet']); ?></td>
                                    <td style="color: black; border: 1px solid black"><?= htmlspecialchars($outlet['alamat_outlet']); ?></td>
